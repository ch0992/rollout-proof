...
| [환경 자동화 스펙](./environment-automation-spec.md) | Environment as Code mode, provider interface, 멱등성과 evidence 계약 | 0.1-draft |
| [Environment Foundation Task 인덱스](./environment-task-index.md) | 로컬 인프라 자동화 Task, 평가서, Issue와 dependency 연결 | Completed |
| [AI 환경 구축 Runbook](./ai-environment-runbook.md) | AI 실행 순서, 중단 조건, 성공·실패 보고 형식 | 0.1-draft |
