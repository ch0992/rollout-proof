...
epic: P0-E6
issue: null
branch: "feat/<issue-number>-p0-031-kind-bootstrap"
work_order_version: 1
evaluation_document: ../evaluations/P0-031-evaluation.md
---

# P0-031 작업지시서: Kind cluster bootstrap

## 1. 목적

Kind cluster bootstrap을 독립적으로 구현하고 후속 Task가 의존할 수 있는 검증된 산출물을 만든다.
...
- `test/e2e/kind/Makefile`
- `test/e2e/kind/cluster.yaml`
...
- [ ] AC-1: 지정 Kubernetes node image로 cluster를 만든다.
...
```bash
make -C test/e2e/kind help
make -C test/e2e/kind create
make -C test/e2e/kind delete
```
...
- Branch: `feat/<issue-number>-p0-031-kind-bootstrap`
- Commit prefix: `[P0-031]`
- PR title: `[P0-031] Kind cluster bootstrap`
