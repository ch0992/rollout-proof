...
# P0-025 작업지시서: ADR-0006 HTTP connection profile 결정

## 1. 목적

ADR-0006 HTTP connection profile 결정을 독립적으로 구현하고 후속 Task가 의존할 수 있는 검증된 산출물을 만든다.
...
- net/http와 httptrace 선택
- new/keep-alive 격리와 HTTP/1.1 범위
...
- `docs/adr/0006-http-connection-profiles.md`
- `docs/README.md`
...
- [ ] AC-1: 표준 library 선택 근거가 있다.
- [ ] AC-2: 두 profile의 pool 격리를 명시한다.
- [ ] AC-3: HTTP/2 비목표를 명시한다.
- [ ] AC-4: 문서 인덱스에서 연결된다.
